    ...
    public class Player : NetworkBehaviour
    {
        ...
        */
        ...
        void CmdSearchGame()
        {
            if (MatchMaker.Instance.SearchGame(this, out playerIndex, out matchID))
            {
                ...
                //Host
                if (isServer && playerLobbyUI is not null)
                {
                    playerLobbyUI.SetActive(true);
                }
            }
        ...
        */
        ...
        public void BeginGame()
        {
            ...
            transform.position = new Vector3(UnityEngine.Random.Range(-5, 5), 3, UnityEngine.Random.Range(-5, 5));
        }
